...
const render_parameters::color_model_property render_parameters::color_model_properties[] = {
  ...
  { "kodachrome25", "Kodachrome 25 simulation (subtractive)", "", 0 },
  { "paget", "Paget", "", 0 },
  { "Wall_max_separation", "Wall max separation", "Color corresponding to frequencies described by Wall", 0 },
  { "none", "None", "", 0 },
  { "scan", "scan", "", 0 },
};
...
get_color (image_data &img, render_parameters &rparam, scr_to_img_parameters &param, rgbdata c, progress_info *progress)
{
  ...
  c = r.out_color.hdr_final_color (c);
  return c;
}
static luminosity_t
