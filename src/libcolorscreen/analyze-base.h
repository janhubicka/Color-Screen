...
public:
  ...
  /* Compare linear, density/log and variance-stabilized three-scale noise
     diagnostics for each collected separation.  Read-only.  */
  bool estimate_noise_domain_models (denoise_noise_domain_comparison *red,
