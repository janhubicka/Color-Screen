...
public:
  ...
  /* Compare the same collected sample centers/directions at one and two
     physical lattice spacings.  This is diagnostic only and never changes
     rendering parameters.  */
  bool estimate_noise_scale_models (denoise_noise_scale_estimate *red,
  ...
  /* Compare linear, photographic-density and variance-stabilized three-scale
     noise diagnostics for the RED, GREEN and BLUE collected separations.
     This is read-only and does not change rendering parameters.  */
