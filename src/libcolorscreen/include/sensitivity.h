...
struct richards_curve_parameters hd_to_richards_curve_parameters (const hd_curve_parameters &p);
struct hd_curve_parameters richards_to_hd_curve_parameters (const richards_curve_parameters &rp);
