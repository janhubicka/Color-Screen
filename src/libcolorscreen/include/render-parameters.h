...
struct render_parameters
{
  ...
  void
  set_gray_range (int gray_min, int gray_max, int maxval)
  {
  ...
  void
  get_gray_range (int *min, int *max, int maxval)
  {
    if (!invert)
      {
  ...
  color_matrix
  get_profile_matrix (rgbdata patch_proportions)
  {
    color_matrix subtract_dark (1, 0, 0, -profiled_dark.red, 0, 1, 0,
                                -profiled_dark.green, 0, 0, 1,
                                -profiled_dark.blue, 0, 0, 0, 1);
    color_matrix process_colors (
        profiled_red.red * patch_proportions.red,
        profiled_green.red * patch_proportions.green,
        profiled_blue.red * patch_proportions.blue, 0,
        profiled_red.green * patch_proportions.red,
        profiled_green.green * patch_proportions.green,
        profiled_blue.green * patch_proportions.blue, 0,
        profiled_red.blue * patch_proportions.red,
        profiled_green.blue * patch_proportions.green,
        profiled_blue.blue * patch_proportions.blue, 0, 0, 0, 0, 1);
  ...
  compute_mix_weights (rgbdata patch_proportions)
  {
    ...
    bool verbose = true;
    color_matrix process_colors (sprofiled_red.red, sprofiled_green.red,
                                 sprofiled_blue.red, 0, sprofiled_red.green,
                                 sprofiled_green.green, sprofiled_blue.green,
                                 0, sprofiled_red.blue, sprofiled_green.blue,
                                 sprofiled_blue.blue, 0, 0, 0, 0, 1);
