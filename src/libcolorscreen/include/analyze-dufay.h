...
public:
  ...
  bool find_best_match (int percentake, analyze_dufay &other, const char *filename1, const char *filename2, int *xshift, int *yshift, FILE *report_file = NULL, progress_info *progress = NULL);
