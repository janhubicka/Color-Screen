...
static lru_cache <screen_params, screen, screen *, get_new_screen, 4> screen_cache ("screen");
}
...
{
  return render::precompute_all (grayscale_needed, normalized_patches, m_scr_to_img.patch_proportions (&m_params), progress);
}
bool
