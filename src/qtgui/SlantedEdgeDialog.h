...
/** Configure one slanted-edge measurement before selecting its image area.
    Numerical analysis controls and measurement metadata are collected in one
    place so every generated MTF curve records its wavelength explicitly.  */
...
public:
  ...
  explicit SlantedEdgeDialog(
      ...
      bool hasPreviousMeasurement, QWidget *parent = nullptr);
