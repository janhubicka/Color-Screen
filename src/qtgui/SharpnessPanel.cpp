...
void SharpnessPanel::setupUi() {
  ...
  addCheckboxParameter(
      ...
      }, nullptr, "Included in the focus analyzer optimization loop. Multi-area physical-MTF analysis may optimize Sigma and Defocus together while preserving the measured process-screen carrier MTF.");
  ...
  m_analyzeFocusAreasBtn->setToolTip(
      tr("Verify the discovered regions independently, choose a "
         ...
         "leave-one-out and held-out validation. When physical scanner-MTF "
         "Sigma and Defocus are both enabled, the fit first measures the "
         "process-screen carrier MTF and then chooses their decomposition "
         "without changing that contrast."));
